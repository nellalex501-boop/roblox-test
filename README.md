...
![Spawn view](docs/previews/review-spawn.png)
![Aerial view](docs/previews/review-aerial-se.png)
...
| **Operations Center** | Matchmaking terminals: QUICK MATCH, 1v1, 2v2, 4v4 and PRIVATE (access codes, host picks size and map). Each terminal briefs you on its mode: rules of engagement, match length and the likely battlefield, drawn as a small map. A command wall with a live deployment board. Signals room and briefing room |
...
| **Around the base** | Gate checkpoint, guard towers, barracks, motor pool, comms compound, helipad with a parked helicopter, a staff parking lot (access lane, 14 stalls, reserved spaces), a softball diamond (backstop, dugouts, bleachers, scoreboard), a seven-obstacle assault course behind the Map Room, old broadleaf trees, and beyond the fence woods, rings of hills, a village and the public road bending away into the trees |
...
- the visual review (`09_visual`): no z-fighting anywhere (an exact
  ...
  not covered and plates on solid wall, every world label at least a quarter
  stud tall, street lamps clear of doorways,
